...
//				System.out.println(p_dex);
			...
			while (tour) {
				...
				if(p_hp<=((p_hp*50)/100)) {
					System.out.println("체력이 너무 낮습니다 휴식을 권장합니다");
				}
				switch (tour_flag) {
				case 1:
					System.out.println("----------------------------------------------------------");
					...
					/*	System.out.println(monster_HP);
						...
						while(monster_battle) {
							...
							if(hitrating>5) {
								...
								System.out.println(p_name+"님이"+monster_name+"에게"+p_attk+"의 데미지");
								...
								System.out.println(monster_name+"가"+p_name+"에게"+monster_attk+"의 데미지를 주었습니다");
